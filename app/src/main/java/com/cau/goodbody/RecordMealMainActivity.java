...
public class RecordMealMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_record_meal_main);
        ...
        fab_B.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent pageIntent = new Intent(RecordMealMainActivity.this, PopTestActivity.class);
